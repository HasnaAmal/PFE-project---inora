...
export default function AccountPage() {
  ...
  const handleName = async (e) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/profile/me/name`, { 
        method: 'PATCH', 
        credentials: 'include', 
  ...
  const handleEmail = async (e) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/profile/me/email`, { 
        method: 'PATCH', 
        credentials: 'include', 
        headers: { 'Content-Type': 'application/json' }, 
  ...
  const handlePassword = async (e) => {
    ...
    setPassLoading(true);
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/profile/me/password`, { 
        method: 'PATCH', 
        credentials: 'include', 
        headers: { 'Content-Type': 'application/json' }, 
  ...
  const handleCancelBooking = async () => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/profile/me/bookings/${cancelTarget.id}/cancel`, { 
        method: 'PATCH', 
        credentials: 'include' 
      });
      const data = await res.json();
