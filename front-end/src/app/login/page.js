'use client';
import { Suspense } from 'react'; // ✅ AJOUT : Importer Suspense
import { useState } from 'react';
import { useRouter, useSearchParams } from 'next/navigation';
import Link from 'next/link';
import { useAuth } from '../../context/AuthContext';

// ✅ NOUVEAU : Composant qui contient tout votre code existant
function LoginContent() {
  ...
  // TOUT VOTRE JSX EXISTANT ICI (sans rien changer)
  return (
    <div
...
// ✅ PAGE PRINCIPALE avec Suspense (seulement ceci change)
