    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-12 border border-[#C87D87]/20 text-center">
          ...
          <Link href="/login" className="inline-block bg-gradient-to-r from-[#6B7556] to-[#556b42] text-white px-8 py-3 rounded-xl font-semibold hover:scale-105 transition-all shadow-lg">
            Back to Login
          </Link>
        </div>
      </div>
      ...
      <div className="w-full max-w-md bg-white/90 backdrop-blur-md rounded-xl shadow-2xl p-10 border border-[#C87D87]/20 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full py-4 rounded-xl font-semibold text-white bg-gradient-to-r from-[#6B7556] to-[#556b42] hover:scale-[1.02] transition-all duration-200 shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? 'Resetting...' : 'Reset Password'}
          </button>

          {message && (
            <p className={`p-3 rounded-lg text-center font-medium text-sm ${
          ...
          <div className="text-center">
            <Link 
              href="/login" 
              className="inline-block text-[#C87D87] hover:text-[#6B7556] font-medium transition-colors"
            >
              ← Back to Login
            </Link>
          </div>
