                  ...
                  <div ref={notifRef} className="relative">
                    ...
                    {notifOpen && (
                      <>
                        ...
                        <div
                          className="dropdown-anim z-[100] rounded-2xl overflow-hidden border border-[#C87D87]/20 shadow-[0_16px_48px_rgba(58,48,39,0.18)]
                            fixed left-2 right-2 top-[3.8rem]
                            sm:absolute sm:left-auto sm:right-0 sm:top-auto sm:mt-2.5 sm:w-[22rem]"
                        ...
                        >
                          ...
                          {/* Header */}
                          <div
                            className="flex items-center justify-between px-4 sm:px-5 py-3.5 border-b border-[#C87D87]/15"
                            style={{ background: 'linear-gradient(135deg,#FBEAD6 0%,rgba(200,125,135,0.06) 100%)' }}
                          >
                            <div className="flex items-center gap-2.5">
                              <div className="w-7 h-7 rounded-lg bg-[#C87D87]/12 border border-[#C87D87]/25 flex items-center justify-center flex-shrink-0">
                              ...
                              <div>
                                <p className="font-['Cormorant_Garamond',serif] text-[0.7rem] tracking-[0.18em] uppercase text-[#3a3027] font-semibold">
                                  Notifications
                                </p>
                                {unreadNotifs.length > 0 && (
                            ...
                            <div className="flex items-center gap-2">
                              {unreadNotifs.length > 0 && (
                                <button
                                  ...
                                  className="font-['Cormorant_Garamond',serif] text-[0.58rem] tracking-[0.15em] uppercase text-[#6B7556] border border-[#6B7556]/35 bg-[#6B7556]/8 px-2.5 py-1 rounded-lg hover:bg-[#6B7556] hover:text-[#FBEAD6] transition-all duration-300 whitespace-nowrap"
                                >
                                  Mark all read
                                </button>
                              )}
                              ...
                              <button
                                onClick={() => setNotifOpen(false)}
                                className="sm:hidden w-6 h-6 flex items-center justify-center rounded-full bg-[#C87D87]/10 border border-[#C87D87]/20 text-[#C87D87] text-xs flex-shrink-0"
                              >
                                ✕
                              </button>
                            </div>
                          ...
                          {/* Notification list */}
                          <div className="max-h-[60vh] sm:max-h-[380px] overflow-y-auto divide-y divide-[#C87D87]/10">
                            {notifications.length === 0 ? (
                              <div className="px-5 py-10 text-center">
                                ...
                                <p className="font-['Cormorant_Garamond',serif] italic text-[#7a6a5a]/60 text-sm">
                                  ...
                                  <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <div className="flex items-start justify-between gap-2">
                                        ...
                                        {!notif.read && (
                                          <span className="w-1.5 h-1.5 rounded-full bg-[#C87D87] flex-shrink-0 mt-1.5" />
                                        )}
                                      </div>
                                      ...
                                      {notif.type === 'BOOKING_CONFIRMED' && !notif.read && (
                                        <button
                                          ...
                                          className="mt-2.5 w-full font-['Cormorant_Garamond',serif] text-[0.6rem] tracking-[0.15em] uppercase text-[#FBEAD6] bg-[#6B7556] px-3 py-2.5 sm:py-2 rounded-xl hover:bg-[#4a5240] active:bg-[#4a5240] transition-all duration-300 flex items-center justify-center gap-1.5 shadow-[0_2px_10px_rgba(107,117,86,0.22)] min-h-[40px]"
                                        >
                                      ...
                                      {(notif.type === 'REVIEW_REQUEST' || notif.type === 'FEEDBACK_REQUEST') && !notif.read && (
                                        <button
                                          ...
                                          className="mt-2.5 w-full font-['Cormorant_Garamond',serif] text-[0.6rem] tracking-[0.15em] uppercase text-[#FBEAD6] bg-[#C87D87] px-3 py-2.5 sm:py-2 rounded-xl hover:bg-[#a85e6a] active:bg-[#a85e6a] transition-all duration-300 flex items-center justify-center gap-1.5 shadow-[0_2px_10px_rgba(200,125,135,0.22)] min-h-[40px]"
                                        >
                                          <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.563.563 0 00-.182-.557l-4.204-3.602a.562.562 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                                          </svg>
                          ...
                          {/* Footer ornament — single, outside the list */}
                          <div
                            className="flex items-center justify-center gap-2 py-2 border-t border-[#C87D87]/12"
